...
Original file is located at
    https://colab.research.google.com/drive/1Vy3SnuXMEopDY4rmtxileuMzYiRE6Uxc
"""
...
MONDAY_PATH  = "Monday-WorkingHours.csv"
FRIDAY_PATH  = "Friday-WorkingHours.csv"
...
DROP_COLS = ['Flow ID','Source IP','Destination IP',
             'Source Port','Destination Port','Timestamp']   # these had NaN/inf
...
# save model weights (torch, not joblib)
torch.save(model.state_dict(), "ae_model.joblib")
print("Model saved ✓")
